      ...
      <div class="col-md-12">
        ...
        @endif
          <div class="box box-primary">
              ...
              <!-- form start -->
              <form role="form" method="POST" action="{{ route('insert-products') }}" enctype="multipart/form-data">
                <div class="box-body">
                  @csrf
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Product</label>
                    <input name="produk" type="text" class="form-control" id="perawatan" placeholder="Nama Produk">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Harga Product</label>
                    <input name="harga" type="number" class="form-control" id="kd_perawatan" placeholder="Harga Produk">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="deskripsi" class="form-control" id="editor1" rows="10" cols="80"></textarea>
                  </div>
                </div><!-- /.box-body -->
